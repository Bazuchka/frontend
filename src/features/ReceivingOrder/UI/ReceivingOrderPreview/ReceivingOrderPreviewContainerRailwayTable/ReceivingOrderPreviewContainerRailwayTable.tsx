...
interface ReceivingOrderPreviewContainerRailwayTableProps {
    store: Instance<typeof receivingOrderPreviewContainerStore>;
    orderId: string | undefined;
}

export const ReceivingOrderPreviewContainerRailwayTable: FunctionComponent<ReceivingOrderPreviewContainerRailwayTableProps> =

...
import { receivingOrderPreviewContainerStore } from "src/features/ReceivingOrder/store/ReceivingOrderPreviewStore";

interface ReceivingOrderPreviewContainerVehicleTableProps {
    store: Instance<typeof receivingOrderPreviewContainerStore>;
    orderId: string | undefined;
}

export const ReceivingOrderPreviewContainerVehicleTable: FunctionComponent<ReceivingOrderPreviewContainerVehicleTableProps> =

...
import {
    ...
    CREATE_VEHICLE_CONTAINER,
} from "./const";

export const receivingOrderVehicleContainer = () =>
    testI18n("Receiving Order (Vehicle/Container)", async ({ page, i18nFix }) => {
        ...
        await testI18n.step("can create new receiving order", async () => {
            ...
            await populateForm(page, CREATE_VEHICLE_CONTAINER(i18nFix.t));
            await expect(
                page

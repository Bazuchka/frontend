...
export const clients = () =>
    testI18n("Clients", async ({ page, i18nFix }) => {
        await loadScene({ page, i18nFix }, ["Shared:Reference.dictionary", "Client:menu.clients"]);

        await hasHeaderAndBreadcrumbsStep(["Shared:Reference.dictionary", "Client:menu.clients"], {
            page,
            i18nFix,
        });

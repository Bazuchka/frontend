...
import { shippingOrderPreviewContainerStore } from "src/features/ShippingOrder/store/ShippingOrderPreviewStore";

interface ShippingOrderPreviewContainerVehicleTableProps {
    store: Instance<typeof shippingOrderPreviewContainerStore>;
    orderId: string | undefined;
}

export const ShippingOrderPreviewContainerVehicleTable: FunctionComponent<ShippingOrderPreviewContainerVehicleTableProps> =
